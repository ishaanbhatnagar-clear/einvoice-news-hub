"""
EDICOM News Crawler
Crawls e-invoicing news from EDICOM website
"""
...
class EDICOMCrawler(BaseCrawler):
    """Crawler for EDICOM News"""
    ...
    def base_url(self) -> str:
        return "https://www.edicomgroup.com"
    ...
    def crawl(self) -> List[Dict]:
        ...
        # EDICOM blog has structured e-invoicing content
        urls_to_crawl = [
            f"{self.base_url}/blog",
            f"{self.base_url}/blog/category/einvoicing",
        ]
        ...
        for news_url in urls_to_crawl:
            ...
            # EDICOM blog uses article cards with clear structure
            news_items = soup.select('article, .blog-post, .post-item, [class*="blog"], [class*="post"], .card')
