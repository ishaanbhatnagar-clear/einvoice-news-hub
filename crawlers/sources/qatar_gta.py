"""
Qatar GTA (General Tax Authority) Crawler
Crawls official tax news from gta.gov.qa
"""
...
class QatarGTACrawler(BaseCrawler):
    """Crawler for Qatar General Tax Authority"""
    ...
    def crawl(self) -> List[Dict]:
        """Crawl Qatar GTA news and announcements"""
        articles = []
                ...
                for link in links[:30]:
                    try:
                        ...
                        article = self.create_article(
                            ...
                            title=text,
                            summary=f"Official update from Qatar GTA: {text}",
                            url=url,
