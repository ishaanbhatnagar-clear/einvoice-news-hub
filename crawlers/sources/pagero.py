"""
Pagero News Crawler
Crawls e-invoicing news from Pagero website
"""
...
class PageroCrawler(BaseCrawler):
    """Crawler for Pagero News"""
    ...
    def crawl(self) -> List[Dict]:
        ...
        news_items = soup.select('.news-item, .post, article, .card, [class*="news"]')
